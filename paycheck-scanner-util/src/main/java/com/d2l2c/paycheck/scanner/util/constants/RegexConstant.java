...
public interface RegexConstant {
	...
	public static final String FEDERAL_TAX = "((\\bFederal Income Tax\\b)|(\\bFEDERAL W/H\\b))";

	public static final String STATE_TAX = "((\\bSTATE W/H\\b)|(\\bSTATE SDI\\b)|(\\bNJ Income Tax\\b)|(\\bWV Income Tax\\b))";

	public static final String SOCIAL_SECURITY = "((\\bSocial Security\\b)|(\\bOASDI\\b))";

	public static final String MEDICARE = "(\\bMEDICARE\\b)";
